      ...
      <div className="space-y-4 md:space-y-5">
        ...
        <div className="flex gap-2 md:gap-3">
          ...
          <select value={statusFilter} onChange={e => setStatusFilter(e.target.value)}
            className="px-2 md:px-3 py-2 border border-slate-400 rounded-lg bg-white text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white min-w-0">
